...
class testHTTPServer_RequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            message += "<p>Last Update " + str(int((datetime.datetime.now() - last_received_temperatures).total_seconds())) +" seconds ago</p>"
...
def get_temperatures():
    while True:
        try:
            ...
            global last_received_temperatures
            last_received_temperatures = datetime.datetime.now()
        except TimeoutError:
